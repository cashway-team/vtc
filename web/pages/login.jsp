...
<%@page import="com.cashway.common.Setting" %>
<%@page import="com.cashway.util.SettingUtils" %>
<%@page import="com.cashway.util.SpringUtils" %>
<%@page import="com.cashway.common.Setting.CaptchaType" %>
<%@page import="com.cashway.common.Setting.AccountLockType" %>
<%@page import="com.cashway.service.RSAService" %>
...
<head>
    ...
    <%
        if (applicationContext != null) {
            RSAService rsaService = SpringUtils.getBean("rsaService", RSAService.class);
    ...
    <script type="text/javascript">
        $().ready(function () {
            ...
            $captchaImage.click(function () {
                $captchaImage.attr("src", "<%=base%>/login/captcha.jhtml?captchaId=<%=captchaId%>&timestamp=" + (new Date()).valueOf());
            });
    ...
    <form id="loginForm" action="login.jsp" method="post">
        ...
        <table>
                ...
                <td>
                    <input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4"
                           autocomplete="off"/><img id="captchaImage" class="captchaImage"
                                                    src="<%=base%>/login/captcha.jhtml?captchaId=<%=captchaId%>"
            ...
            <tr>
                ...
                <td>
                    <input type="button" class="homeButton" value="" onclick="location.href='<%=base%>/'"/><input
                        type="submit" class="loginButton" value="<%=SpringUtils.getMessage("admin.login.login")%>"/>
                </td>
            </tr>
        </table>
